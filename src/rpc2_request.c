...
static void timeout_timer_cb(struct uloop_timeout *tm) {
...
struct json_object *rpc_params(struct rpc_request *req) { return req->params; }

void *rpc_handler_data(struct rpc_request *req) { return req->handler_data; }

struct rpc_ctx *rpc_request_ctx(struct rpc_request *req) { return req->ctx; }
...
void *rpc_get_userdata(struct rpc_request *req) { return req->user_data; }
